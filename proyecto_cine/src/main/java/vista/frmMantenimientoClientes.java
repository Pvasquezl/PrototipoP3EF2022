...
public class frmMantenimientoClientes extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeCombos() {
        ...
        for (int i = 0; i < clientes.size(); i++) {
            cbox_aplicacion.addItem(String.valueOf(clientes.get(i).getiId_cliente()));
        }
    }
    ...
    public void llenadoDeTablas() {
        ...
        for (int i = 0; i < clientes.size(); i++) {
            dato[0] = Integer.toString(clientes.get(i).getiId_cliente());
            dato[1] = clientes.get(i).getsNombre();
            dato[2] = clientes.get(i).getsNit();
    ...
    public void buscarClientes() {
        ...
        daoClientes clienteDAO = new daoClientes();
        clienteAConsultar.setiId_cliente(Integer.parseInt(txtbuscado.getText()));
        clienteAConsultar = clienteDAO.query(clienteAConsultar);
        txtNombre.setText(clienteAConsultar.getsNombre());
        txtnit.setText(clienteAConsultar.getsNit());
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clienteAEliminar.setiId_cliente(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        clienteAInsertar.setsNombre(txtNombre.getText());
        clienteAInsertar.setsNit(txtnit.getText());
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        clienteAActualizar.setsNombre(txtNombre.getText());
        clienteAActualizar.setsNit(txtnit.getText());
